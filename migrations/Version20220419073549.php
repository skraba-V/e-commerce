 ...
 */
final class Version20220419073549 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, fk_shipping_comp_id INT NOT NULL, fk_user_id_id INT NOT NULL, order_date DATE NOT NULL, total DOUBLE PRECISION NOT NULL, INDEX IDX_F5299398FD2F5A78 (fk_shipping_comp_id), UNIQUE INDEX UNIQ_F52993986DE8AF9C (fk_user_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, fk_category_id INT NOT NULL, fk_supplier_id INT NOT NULL, name VARCHAR(100) NOT NULL, description VARCHAR(1000) DEFAULT NULL, picture VARCHAR(255) DEFAULT NULL, price DOUBLE PRECISION NOT NULL, size DOUBLE PRECISION NOT NULL, weight DOUBLE PRECISION NOT NULL, stock INT NOT NULL, discount INT DEFAULT NULL, hidden TINYINT(1) NOT NULL, INDEX IDX_D34A04AD7BB031D6 (fk_category_id), INDEX IDX_D34A04AD432BC1B8 (fk_supplier_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE shopping_cart (id INT AUTO_INCREMENT NOT NULL, fk_user_id_id INT NOT NULL, fk_product_id_id INT DEFAULT NULL, fk_order_id INT DEFAULT NULL, amount INT NOT NULL, INDEX IDX_72AAD4F66DE8AF9C (fk_user_id_id), INDEX IDX_72AAD4F6BA5290C9 (fk_product_id_id), INDEX IDX_72AAD4F6BFB72EE6 (fk_order_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE shopping_cart ADD CONSTRAINT FK_72AAD4F6BFB72EE6 FOREIGN KEY (fk_order_id) REFERENCES `order` (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE shopping_cart DROP FOREIGN KEY FK_72AAD4F6BFB72EE6');
